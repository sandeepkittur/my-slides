...
interface FindCutNotationsOptions {
    reCutBefore?: RegExp;
    reCutAfter?: RegExp;
    reCutStart?: RegExp;
    reCutEnd?: RegExp;
}
declare function findCutNotations(code: string, meta: Pick<TwoslashReturnMeta, 'removals'>, options?: FindCutNotationsOptions): Range[];
