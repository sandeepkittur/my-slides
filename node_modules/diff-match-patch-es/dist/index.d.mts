...
//#endregion
export { DIFF_DELETE, DIFF_EQUAL, DIFF_INSERT, Diff, DiffMatchPathOptions, DiffOperation, Patch, ResolvedOptions, defaultOptions, diffMain as diff, diffMain, diffCharsToLines, diffCleanupEfficiency, diffCleanupMerge, diffCleanupSemantic, diffCleanupSemanticLossless, diffCommonPrefix, diffCommonSuffix, diffFromDelta, diffLevenshtein, diffLinesToChars, diffPrettyHtml, diffText1, diffText2, diffToDelta, diffXIndex, matchMain as match, matchMain, matchAlphabet, matchBitap, patchMake as patch, patchMake, patchAddPadding, patchApply, patchDeepCopy, patchFromText, patchSplitMax, patchToText, resolveOptions };